using Cinemaster.Application.Person;
...
namespace Api.Test
{
    ...
    public class PersonControllerTest : IntegrationTestBuilder
    {
        ...
        {
            var postContent = new Cinemaster.Application.Person.CreatePersonCommand
            {
                Email = "john@doe.com",
                FirstName = "john",
                LastName = "doe"
        ...
        {
            var postContent = new Cinemaster.Application.Person.CreatePersonCommandAsync("john", "doe", "john@doe.com");
